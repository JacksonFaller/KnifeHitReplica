...
public class GameMaster : MonoBehaviour
{
    ...
    [SerializeField]
    private Transform _knifePrefab;

    [SerializeField]
    private List<Sprite> _knifeSprites = new List<Sprite>(16);

    [SerializeField]
    private Transform _target;

    [SerializeField]
    private Animation _backgroundImpact;
    ...
    [SerializeField]
    private KnifesRemainController _knifesRemainController;

    [SerializeField]
    private Animation _gameOverScreenTint;

    [SerializeField]
    private GameObject _restartButton;

    [SerializeField]
    private int _knifesRemain;

    [SerializeField]
    private Transform _stageClearEffect;

    [SerializeField]
    private bool _playTargetAppearanceAnimation;
